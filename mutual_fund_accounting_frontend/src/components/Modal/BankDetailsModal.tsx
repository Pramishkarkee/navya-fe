            ...
            {data?.responseData?.map((bank) => (
              <Grid item xs={12} key={bank?.id}>
                ...
                >
                  ...
                  <Typography>{bank?.bank_name || 'N/A'} </Typography>
                </Box>
                <Box
                  sx={{
                    display: "flex",
                ...
                >
                  <Typography
                    variant="body1"
                    sx={{ color: "#616161" }}
                  >{`Bank Code: `}</Typography>
                  <Typography>{bank?.bank_code || 'N/A'} </Typography>
                </Box>
                <Box
                  sx={{
                    display: "flex",
                ...
                >
                  <Typography
                    variant="body1"
                    sx={{ color: "#616161" }}
                  >{`Bank Address: `}</Typography>
                  <Typography>{bank?.bank_address || 'N/A'} </Typography>
                </Box>
                <Box
                  sx={{
                    display: "flex",
                ...
                >
                  ...
                  <Typography>{bank?.swift_code || 'N/A'} </Typography>
                </Box>
                <Box
                  sx={{
                    display: "flex",
                ...
                >
                  <Typography
                    variant="body1"
                    sx={{ color: "#616161" }}
                  >{`Bank Type`}</Typography>
                  <Typography>
                    {bankTypeMap[bank?.bank_type] || 'N/A'}
                  </Typography>
                </Box>
                ...
                >
                  <Typography
                    variant="body1"
                    sx={{ color: "#616161" }}
                  >{`NRB Symbol `}</Typography>
                  <Typography>{bank?.nrb_symbol} </Typography>
                </Box> */}
                <Box
                  sx={{
                    display: "flex",
                ...
                >
                  <Typography
                    variant="body1"
                    sx={{ color: "#616161" }}
                  >{`Main Branch `}</Typography>
                  <Typography>
                    {bank?.is_main_branch ? "Yes" : "No"}{" "}
                  </Typography>
                </Box>
