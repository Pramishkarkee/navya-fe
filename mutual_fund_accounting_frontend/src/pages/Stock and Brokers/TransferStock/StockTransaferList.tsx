...
import { TransferedStockTableEntryHeader } from "constants/TransferStock/TransferedStockTableHeader";
...
const schema = yup
  ...
  .required();
export default function TransferStockList() {
    ...
    <Box>
      ...
      <Box>
        {displayData?.length > 0 ? (
          ...
          >
            <ReceiptTable
              columns={TransferedStockTableEntryHeader}
              data={displayData}
