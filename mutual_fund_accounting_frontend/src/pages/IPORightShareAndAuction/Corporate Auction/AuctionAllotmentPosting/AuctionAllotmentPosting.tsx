...
import {
  useGetPendingAuctionAllotmentList,
  useGetPendingAuctionList,
  usePostPendingAuctionAllotment,
  usePostPendingAuctionAllotmentReject,
...
const AuctionAllotmentPosting = () => {
  ...
  const { data: pendingAuctionList } = useGetPendingAuctionAllotmentList(
  ...
  const { mutate: ApprovePendingAuction, isPending: PendingAuction } =
    usePostPendingAuctionAllotment();
  const { mutate: RejectPendingAuction } =
    usePostPendingAuctionAllotmentReject();
      ...
      },
      {
        ...
        cell: (data) => {
          return (
            ...
            >
              {parseFloat(data.row.original.applied_units).toLocaleString(
                undefined,
                { minimumFractionDigits: 2, maximumFractionDigits: 2 }
              )}
            </Typography>
      ...
      },
      {
        ...
        cell: (data) => {
          return (
            ...
            >
              {parseFloat(data.row.original.deposit_amount).toLocaleString(
                undefined,
                { minimumFractionDigits: 2, maximumFractionDigits: 2 }
              )}
            </Typography>
...
export default AuctionAllotmentPosting;
